...
Set up the data and the calculator first - see the two sections [Getting the champout data](#getting-the-champout-data)and [Getting the damage calculator](#getting-the-champout-dataGetting the damage calculator) below, which are the parts that need cloning - then:
